# --- PARAMETERS ---
# v3.1 CADAM-style parametric bpy script.
# Generated from collector_10201775.jpg via reference_image_to_scene + build_seed_params.
# All numeric / color literals affecting geometry, materials, lighting, camera, render
# are declared here. Tweak values via blender_apply_params (or rewrite this block) —
# never inline magic numbers in the script body.

# Display case (clear acrylic, in metres — Blender units)
CASE_WIDTH_M = 0.16
CASE_HEIGHT_M = 0.30
CASE_DEPTH_M = 0.16
CASE_WALL_M = 0.0035          # 3.5 mm acrylic
CASE_BASE_HEIGHT_M = 0.012    # plastic base footprint
CASE_BASE_COLOR = (0.95, 0.95, 0.95, 1.0)
CASE_GLASS_IOR = 1.49         # PMMA acrylic
CASE_GLASS_ROUGHNESS = 0.04
CASE_GLASS_TRANSMISSION = 1.0
CASE_GLASS_TINT = (0.97, 0.99, 1.0, 1.0)

# Figure overall (proxy — block out, ready for an imported sculpt to swap in)
FIGURE_HEIGHT_M = 0.25
FIGURE_BASE_Z = 0.013         # rests on the inner base plate
FIGURE_FACE_DIRECTION_DEG = 22.0   # slight 3/4 rotation toward camera

# Skin / hair / outfit colors (matte vinyl)
SKIN_COLOR = (0.78, 0.55, 0.39, 1.0)
HAIR_COLOR_BASE = (0.04, 0.04, 0.04, 1.0)
HAIR_COLOR_TIPS = (0.62, 0.43, 0.20, 1.0)
...
PROXY_ROUGHNESS = 0.55        # matte vinyl

# Lighting — 3-point softbox + bright env
KEY_LIGHT_ENERGY_W = 800.0
KEY_LIGHT_SIZE_M = 0.6
KEY_LIGHT_LOC = (0.45, -0.55, 0.55)   # top-front-right
KEY_LIGHT_COLOR_K = 5600
FILL_LIGHT_ENERGY_W = 250.0
FILL_LIGHT_SIZE_M = 0.8
FILL_LIGHT_LOC = (-0.55, -0.50, 0.45) # top-front-left, larger softbox
RIM_LIGHT_ENERGY_W = 0.0      # near-shadowless catalog look
ENV_STRENGTH = 1.6            # bright soft white environment (no HDRI yet)
ENV_TOP_COLOR = (1.0, 1.0, 1.0, 1.0)
ENV_BOTTOM_COLOR = (0.85, 0.85, 0.86, 1.0)

# Camera — 3/4 front-left, slight low angle, ~0.6 m
CAM_LOC = (-0.34, -0.48, 0.13)
CAM_LOOK_AT = (0.0, 0.0, 0.15)
CAM_FOCAL_LEN_MM = 85.0
CAM_DOF_F_STOP = 8.0
CAM_DOF_USE = False           # full focus through the box

# Render — Cycles, 2K square (matches reference 700x700 ratio scaled up)
RENDER_ENGINE = "CYCLES"
RENDER_SAMPLES = 256
RENDER_DENOISER = "OPTIX"     # falls back to OPENIMAGEDENOISE if no Optix
RENDER_RES_X = 1400
RENDER_RES_Y = 1400
RENDER_FILM_TRANSPARENT = False
RENDER_FILEPATH = "/Users/tatsheen/claw-architect/openclaw-blender-mcp/uploads/collector_10201775_render.png"
SAVE_BLEND_PATH = "/Users/tatsheen/claw-architect/openclaw-blender-mcp/uploads/collector_10201775_scene.blend"

# Color management — Filmic compresses dark albedos for product shots; Standard
# preserves the actual material colors. AgX is Blender 4+ default mid-ground.
